...
<div id="content">
	...
	<p style="font-size:2em;font-weight:bold;margin-bottom:40px;">Claimant Login</p>
	<form method="POST">
		<p><input type="number" placeholder="CLAIMANT ID" name="claimant_id" min="1001" max="9999" required></p>
	...
	<!--<p><a href="#">Not Registered Yet. Sign Up</a></p-->
</div>
</body>
</html>